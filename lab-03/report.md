...
subtitle: "Модель боевых действий - вариант 69"
...
В начальный момент времени страна $X$ имеет армию численностью 23450 человек, а в распоряжении страны $Y$ армия численностью в 11250 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.312x(t) - 0.741y(t) + |cos(t+2)|
	\\   
	\frac{dy}{dt}= -0.36x(t) - 0.591y(t) + |sin(t+2)|
 \end{cases}
$$
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.355(t) - 0.799y(t) + cos(2t)+1
	\\   
	\frac{dy}{dt}= -0.299x(t)y(t) - 0.566y(t) + sin(10t)+1
 \end{cases}
$$
