...
subtitle: "Модель хищник-жертва - вариант 9"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.21x(t) + 0.049y(t)x(t)
	\\   
	\frac{dy}{dt} = 0.41y(t) - 0.037y(t)x(t)
 \end{cases}
$$

Постройте график зависимости численности хищников от численности жертв, а также графики изменения численности хищников и численности жертв 
при следующих начальных условиях: $x_0=14, y_0=9$
...
Стационарное состояние $x_0=\frac{a}{b}=4.286, y_0=\frac{c}{d}=11.081$
